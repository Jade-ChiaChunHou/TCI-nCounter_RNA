  ...
  write.csv(result, path)
    ...
    # group bar plot
      ...
      g2_select = c('Pink1', 'Atg1', 'PARP1','PARP2','NADSYN','MRPS5')
     
      # concentration 1
      folder = "/home/tcigene/jade/ncounter/result/plot/2579/"
      plant_name = "鳳梨釋迦萃取"
      team_name = c("控制組", "鳳梨釋迦萃取 0.25 mg/ml 24h", "鳳梨釋迦萃取 0.25 mg/ml 48h","鳳梨釋迦萃取 0.5 mg/ml 24h", "鳳梨釋迦萃取 0.5 mg/ml 48h")
      team = c("mock_nor", "X2579L.24h1", "X2579L.48h1", "X2579H.24h1", "X2579H.48h1")
      color = c("#F24D98", "#F24D98", "#59D044", "#F3A002", "#F2F44D")
      team_num = length(team)
      ...
      color = c("#2e9fff", "#58d68d", "#ffcd00", "#ae63e4", "#ff3c41")
